...
@SpringComponent
@UIScope
public class JournalEditorCopy extends VerticalLayout {
    private JournalItem journalItem;
    private JournalService journalService;
    private Binder<JournalItem> binder = new Binder<>(JournalItem.class);
    private JournalEditorCopy.ChangeHandler changeHandler;
    private Button save;
    private Tabs tabs;
    private Tab general;
    private Tab setup;
    ...
    public JournalEditorCopy(JournalService journalService) {
    ...
    public void setChangeHandler(JournalEditorCopy.ChangeHandler h) {
